...
public class EditarEnfermero extends JDialog {
	...
	public EditarEnfermero(JTable tabla) {
		...
		
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setActionCommand("editarEnfermero");
				okButton.addActionListener(new EnfermeroController(this, idTextField, nombreTextField, apellidoTextField, nColegiadoTextField));
