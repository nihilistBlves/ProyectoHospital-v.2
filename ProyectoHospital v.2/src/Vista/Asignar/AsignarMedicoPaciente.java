...
import Control.MedicoPacienteController;

public class AsignarMedicoPaciente extends JDialog {
	...
	public AsignarMedicoPaciente(JTable tabla) {
		...
		sinAsignarTable.setModel(new MedicoPacienteController(tabla).rellenarTablaPacienteSinAsignar());
		...
		asignadosTable.setModel(new MedicoPacienteController(tabla).rellenarTablaPacienteAsignados());
		...
		desasignarButton.addActionListener(new MedicoPacienteController(tabla, asignadosTable, sinAsignarTable));
		...
		asignarButton.addActionListener(new MedicoPacienteController(tabla, asignadosTable, sinAsignarTable));
		contentPanel.add(asignarButton);
		{
			...
			buscarTextField.addKeyListener(new MedicoPacienteController(buscarTextField, tabla, asignadosTable, sinAsignarTable));
