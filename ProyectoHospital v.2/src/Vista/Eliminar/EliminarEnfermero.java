...
public class EliminarEnfermero extends JDialog {
	...
	public EliminarEnfermero(JTable tabla) {
		...
		JLabel seguroLabel = new JLabel("¿Está seguro de querer eliminar el siguiente enfermero?");
		...
		JLabel dniLabel = new JLabel("Nº Colegiado");
		dniLabel.setBounds(365, 78, 84, 16);
		...
		dniTextField.setColumns(10);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setActionCommand("eliminarEnfermero");
				okButton.addActionListener(new EnfermeroController(this, tabla));
