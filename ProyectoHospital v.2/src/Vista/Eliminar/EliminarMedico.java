...
public class EliminarMedico extends JDialog {
	...
	public EliminarMedico(JTable tabla) {
		...
		JLabel seguroLabel = new JLabel("¿Está seguro de querer eliminar el siguiente médico?");
		...
		dniTextField.setColumns(10);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setActionCommand("eliminarMedico");
				okButton.addActionListener(new MedicoController(this, tabla));
